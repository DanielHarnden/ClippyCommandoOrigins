...
If you want to open the project in Unity on your own device:
	Clone the repository to your Unity Projects folder (on Windows, this should be in your Documents folder). 
	Open the project through Unity Hub (make sure the version is Unity 2020.3.1f1. 
	Unity will add all the necessary files not included in the GitHub project, and you can mess around with the code and assets to your heart’s content.
...
If you just want to play the game:
	The latest version is available at https://beanmeister12.itch.io/clippy-commando
