...
public class Level10 : MonoBehaviour
{
    ...
    void OnEnable() 
    {
        ...
        player.transform.position = new Vector3(93, -154, 0);
        GameObject.FindGameObjectWithTag("MainCamera").transform.position = new Vector3(93, -154, 0);
        player.GetComponent<PlayerStatsStory>().Initialize(new bool[]{true, true, true, true}, 3, 1000);
        player.GetComponent<PlayerStatsStory>().Initialize(new bool[]{true, true, true, true}, 4, 10);
        GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerStatsStory>().enemiesLeft = 61;
        ...
        gg.center = new Vector3 (93, -148, 0);
        gg.SetDimensions(275, 200, 0.5f);
