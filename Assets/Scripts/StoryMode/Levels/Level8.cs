...
public class Level8 : MonoBehaviour
{
    ...
    void OnEnable() 
    {
        ...
        player.GetComponent<PlayerStatsStory>().Initialize(new bool[]{true, true, true, false}, 1, 64);
        GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerStatsStory>().enemiesLeft = 19;
        ...
        gg.center = new Vector3 (98, -100, 0);
        gg.SetDimensions(150, 250, 0.5f);
