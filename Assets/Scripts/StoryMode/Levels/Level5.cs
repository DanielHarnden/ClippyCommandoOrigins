...
public class Level5 : MonoBehaviour
{
    ...
    void OnEnable() 
    {
        ...
        player.transform.position = new Vector3(49, -301, 0);
        GameObject.FindGameObjectWithTag("MainCamera").transform.position = new Vector3(-49, -301, 0);
        player.GetComponent<PlayerStatsStory>().Initialize(new bool[]{true, true, false, false}, 1, 256);
        GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerStatsStory>().enemiesLeft = 22;
        ...
        gg.center = new Vector3 (112, -274, 0);
