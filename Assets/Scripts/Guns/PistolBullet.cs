...
public class PistolBullet : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D colObj) 
    {
        ...
        // TODO: Might be smart to give enemies their own enemyStats.cs that their AI script inherits from from, that way this switch statement won't be needed. And enemy tags wouldn't be needed either I think.
